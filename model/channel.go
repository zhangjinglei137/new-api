...
func (channel *Channel) ValidateSettings() error {
	...
	if constant.IsAdvancedCustomChannelType(channel.Type) || constant.IsAdvancedCustomChannel(channel.Type) {
	...
	if (constant.IsAdvancedCustomChannelType(channel.Type) || constant.IsAdvancedCustomChannel(channel.Type)) && channelOtherSettings.UpstreamModelUpdateCheckEnabled {
