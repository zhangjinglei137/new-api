...
func TestChannelResetBalanceRouteUsesOperatePermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodPost, "/reset_balance/:id", authz.ChannelOperate, controller.ResetChannelBalance)
}
